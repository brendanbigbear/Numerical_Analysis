#Matrix Multiplication and Strassen Algorithm Implementation
...
save_matrix_to_file(matrix2, "matrix2.txt")

print("Matrices saved to 'matrix1.txt' and 'matrix2.txt'.")

result_matrix, num_multiplications, num_additions = multiply_matrices_naive(matrix1, matrix2)

save_matrix_to_file(result_matrix, "multiplication_result.txt")
...
if __name__ == "__main__":
    #Load
    matrix1 = load_matrix_from_file("matrix1.txt")
    matrix2 = load_matrix_from_file("matrix2.txt")
    ...
    #File
    save_matrix_to_file(result_matrix_strassen, "strassen_multiplication_result.txt")